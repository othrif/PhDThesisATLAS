...
{\bfseries Yields channel}           & SR3b1              \\[-0.05cm]
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
Observed events          & $1$                    \\
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
Fitted bkg events         & $1.27 \pm 0.35$              \\
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
        Fitted ttZ events         & $0.25 \pm 0.10$              \\
%%
        Fitted ttW events         & $0.25 \pm 0.12$              \\
%%
        Fitted Diboson events         & $0.04_{-0.04}^{+0.04}$              \\
%%
        Fitted Rare events         & $0.73 \pm 0.24$              \\
%%
...
\end{center}
\caption{Fit results in signal region SR3b1 for an integrated luminosity of 36.47~fb$^{-1}$.
...
\label{table.results.systematics.in.logL.fit..Yields.SR3b1}
\end{table}
\clearpage
%