...
To illustrate the procedure, we show the optimization procedure for the sbottom pair production only, 
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth,page=3]{2bs.pdf}
...
\begin{figure}[htb] 
\centering
\includegraphics[width=\textwidth]{NBJET70_20_afterlepton_3LSS_0_physics__v47_343637.pdf}
