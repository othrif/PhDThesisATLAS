...
%Figure~\ref{fig:dataMC_2lep} shows the dilepton invariant mass distributions for both opposite-sign (
%OS) and same-sign (SS) dilepton events, 
...
\begin{figure}[htb!]
\centering
{\includegraphics[width=.75\textwidth]{DATAMC/Mll_ee_Incl_OS_log.pdf}}
...
\begin{figure}[htb!]
\centering
{\includegraphics[width=.75\textwidth]{DATAMC/Mll_ee_Incl_SS3L_log.pdf}}
...
\begin{figure}[htb!]
\centering
{\includegraphics[width=.75\textwidth]{DATAMC/Mll_mm_Incl_OS_log.pdf}}
...
\begin{figure}[htb!]
\centering
{\includegraphics[width=.75\textwidth]{DATAMC/Mll_mm_Incl_SS3L_log.pdf}}
...
the background prediction using data-driven methods.
 ...
 \begin{figure}[htb!]
 \centering
 {\includegraphics[width=0.75\textwidth]{DATAMC/LEPPt_ee_Incl_SS3L_log.pdf}}
...
\end{figure}
 ...
 \begin{figure}[htb!]
 \centering
{\includegraphics[width=0.75\textwidth]{DATAMC/LEPPt_em_Incl_SS3L_log.pdf}}
...
\end{figure}
 ...
 \begin{figure}[htb!]
 \centering
{\includegraphics[width=0.75\textwidth]{DATAMC/LEPPt_mm_Incl_SS3L_log.pdf}}
