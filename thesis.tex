...
\section{Validation of Backgrounds}\label{sec:bkg.val}
\input{texfiles/sec.bkg.val.tex}
\section{Expection in the Signal Regions}\label{sec:bkg.exp}
\input{texfiles/sec.bkg.exp}
%-------------------------------------------------------------------------------
