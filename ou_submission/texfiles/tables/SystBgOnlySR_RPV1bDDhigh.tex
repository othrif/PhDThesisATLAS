...
{\bfseries Uncertainty of channel}                                    & SR\_RPV1bDDhigh            \\
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
Total background expectation             &  $3.84$       \\
%% \\
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
Total statistical $(\sqrt{N_{\mathrm exp}})$              & $\pm 1.96$       \\
%%
Total background systematic               & $\pm 0.97\ [25.42\%] $             \\
\noalign{\smallskip}\hline\noalign{\smallskip}
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
alpha\_theoryUncertRare\_SR\_RPV1bDDhigh         & $\pm 0.80$       \\
%%
alpha\_theoryUncertTTbarV\_SR\_RPV1bDDhigh         & $\pm 0.50$       \\
%%
alpha\_JET\_scale\_NP1         & $\pm 0.26$       \\
%%
gamma\_stat\_SR\_RPV1bDDhigh\_cuts\_bin\_0         & $\pm 0.21$       \\
%%
alpha\_FT\_JVT         & $\pm 0.20$       \\
%%
alpha\_theoryUncertDiboson\_SR\_RPV1bDDhigh         & $\pm 0.18$       \\
%%
alpha\_JET\_scale\_NP2         & $\pm 0.17$       \\
%%
Lumi         & $\pm 0.16$       \\
%%
...
\label{table.results.bkgestimate.uncertainties.SR_RPV1bDDhigh}}
\end{table}
\clearpage
%