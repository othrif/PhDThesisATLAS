...
Non-prompt leptons are really reconstructed leptons that did not originate from 
the hard interaction, and are considered to be fake leptons for the purpose 
of this analysis. Non-prompt leptons can be produced from heavy flavor meson decays with a low energy activity 
